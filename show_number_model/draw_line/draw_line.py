...
plt.plot(x1, y3, 'v-', label="Test Accuracy", color='orange')
# plt.xlabel('Epoches', font1)
plt.legend()
plt.savefig("./train-accuracy-vs-test-accuracy.jpg")
plt.show()
...
plt.tick_params(labelsize=18)
plt.plot(x1, Loss_list_train, 'o-', label="Train Loss")
plt.plot(x1, Loss_list_test, 'v-', label="Test Loss", color='orange')
# plt.xlabel('Epoches', font1)
plt.legend()
plt.savefig("./train-loss-vs-test-loss.jpg")
plt.show()
